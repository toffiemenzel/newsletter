...
needle = '<div data-role="layout-vertical" class="layout_wrapper__v_mP4 layout_vertical__mBSE_"'  
pos = 0
out = []
...
while True:
    ...
    while i < len(text):
        ...
        # EOF erreicht ohne schließendes </div>
        break
...
def remove_html_blocks(tag_start, tag_end, text):
    ...
    while True:
        ...
        if end == -1:
            # kaputtes HTML → alles ab tag_end weg
            break
